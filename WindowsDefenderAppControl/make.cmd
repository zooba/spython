...
rc -nologo -foobj\spython.res spython.rc
cl -nologo %_MD% -c spython.c -Foobj\spython.obj -Iobj -Zi -O2 %_PYTHONINCLUDE%
@if errorlevel 1 exit /B %ERRORLEVEL%
link /nologo obj\spython.obj obj\spython.res advapi32.lib wintrust.lib /out:spython.exe /debug:FULL /pdb:spython.pdb /libpath:"%_PYTHONLIB%"
@if errorlevel 1 exit /B %ERRORLEVEL%
